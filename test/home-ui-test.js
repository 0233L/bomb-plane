...
const testSrc = [
  ...
  '  state.sonarResults = [];',
  '',
  '  // ===== 10. 毁灭菇选区：3×3 完整外圈方框（中心 2px 定位标记，4 角格走两条边） =====',
  '  lines.push("10. 毁灭菇完整方框");',
  ...
  '  check("中心格内缩 2px 定位标记", doomBs(5, 5).indexOf("inset 0 0 0 2px #f59e0b") !== -1);',
  '  check("左上角格两条边（顶线 + 左边）", doomBs(4, 4).indexOf("inset 0 3px 0 0") !== -1 && doomBs(4, 4).indexOf("inset 3px 0 0 0") !== -1);',
  '  check("上边格只有顶线", doomBs(4, 5).indexOf("inset 0 3px 0 0") !== -1 && doomBs(4, 5).indexOf("inset 3px 0 0 0") === -1);',
  '  check("下边格只有底线", doomBs(6, 5).indexOf("inset 0 -3px 0 0") !== -1);',
  '  check("左边格只有左线", doomBs(5, 4).indexOf("inset 3px 0 0 0") !== -1);',
  '  check("右边格只有右线", doomBs(5, 6).indexOf("inset -3px 0 0 0") !== -1);',
  '  check("区域外格无框", (doomBs(3, 4).indexOf("f59e0b") === -1));',
